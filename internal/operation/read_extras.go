...
func additionalReadOperationSpecs() []OperationSpec {
	return []OperationSpec{
		...
		},
		{
			...
			GeneratedCLI: true, Method: "POST", Route: "/api/v1/clusters/:id/runtime-storage/:kind/list", Mode: ModeNormal,
			AuthRequired: true, Risk: RiskR0, Revision: 1, UsesAgent: true, SupportsPick: true,
			Input: []InputSpec{
				{Name: "id", Location: InputPath, Required: true, Description: "Cluster ID"},
				{Name: "kind", Location: InputPath, Required: true, Description: "Runtime storage kind: checkpoint or imap"},
			...
			Example:       "stx cluster runtime-storage list 6 checkpoint --request-file ./runtime-storage-list.json",
		...
		},
		{
			...
			GeneratedCLI: true, Method: "POST", Route: "/api/v1/clusters/:id/runtime-storage/:kind/preview", Mode: ModeNormal,
			AuthRequired: true, Risk: RiskR0, Revision: 1, UsesAgent: true, SupportsPick: true,
			Input: []InputSpec{
				{Name: "id", Location: InputPath, Required: true, Description: "Cluster ID"},
				{Name: "kind", Location: InputPath, Required: true, Description: "Runtime storage kind: checkpoint or imap"},
			...
			Example:       "stx cluster runtime-storage preview 6 checkpoint --request-file ./runtime-storage-preview.json",
		...
		},
		{
			...
			GeneratedCLI: true, Method: "POST", Route: "/api/v1/clusters/:id/runtime-storage/checkpoint/inspect", Mode: ModeNormal,
			AuthRequired: true, Risk: RiskR0, Revision: 1, UsesAgent: true, SupportsPick: true,
			...
			Example:       "stx cluster runtime-storage checkpoint inspect 6 --request-file ./checkpoint.json",
		...
		},
		{
			...
			GeneratedCLI: true, Method: "POST", Route: "/api/v1/clusters/:id/runtime-storage/imap/inspect", Mode: ModeNormal,
			AuthRequired: true, Risk: RiskR0, Revision: 1, UsesAgent: true, SupportsPick: true,
			...
			Example:       "stx cluster runtime-storage imap inspect 6 --request-file ./imap.json",
		...
		},
		{
			...
			GeneratedCLI: true, Method: "POST", Route: "/api/v1/installer/runtime-storage/validate", Mode: ModeNormal,
			AuthRequired: true, Risk: RiskR0, Revision: 1, UsesAgent: true, SupportsPick: true,
