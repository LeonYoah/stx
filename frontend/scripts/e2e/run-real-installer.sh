...
if [[ -n "${E2E_REAL_PLAYWRIGHT_SPEC:-}" ]]; then
  PLAYWRIGHT_SPECS+=("${E2E_REAL_PLAYWRIGHT_SPEC}")
else
  PLAYWRIGHT_SPECS+=(
    "e2e/install-wizard-real.spec.ts"
    "e2e/stx-cli-installer-real.spec.ts"
  )
fi
...
CLI_CLUSTER_PORT="$(pick_port "${E2E_INSTALLER_REAL_CLI_CLUSTER_PORT:-39181}")"
CLI_WORKER_PORT="$(pick_port "${E2E_INSTALLER_REAL_CLI_WORKER_PORT:-39481}")"
CLI_HTTP_PORT="$(pick_port "${E2E_INSTALLER_REAL_CLI_HTTP_PORT:-39780}")"
CLI_JAVA_PROXY_PORT="$(pick_port "${E2E_INSTALLER_REAL_CLI_JAVA_PROXY_PORT:-40080}")"
...
export E2E_INSTALLER_REAL_CLI_CLUSTER_PORT="${CLI_CLUSTER_PORT}"
export E2E_INSTALLER_REAL_CLI_WORKER_PORT="${CLI_WORKER_PORT}"
export E2E_INSTALLER_REAL_CLI_HTTP_PORT="${CLI_HTTP_PORT}"
export E2E_INSTALLER_REAL_CLI_JAVA_PROXY_PORT="${CLI_JAVA_PROXY_PORT}"
export E2E_STX_CLI_BIN="${ROOT_DIR}/dist/stx"
...
cd "${FRONTEND_DIR}"
playwright_args=("${PLAYWRIGHT_SPECS[@]}")
