...
| [受管 SeaTunnel 进程身份](./managed-process-identity.md) | 同机多集群的进程命名、PID 校验、停止、监控和心跳约定 | 已填写 |
...
- 涉及 SeaTunnel 进程查找、启停、监控或心跳时，阅读[受管 SeaTunnel 进程身份](./managed-process-identity.md)。
