...
type RegisterRequest struct {
	...
	IpAddress    string                 `protobuf:"bytes,3,opt,name=ip_address,json=ipAddress,proto3" json:"ip_address,omitempty"`          // 主 IP（优先出口 IP）/ Primary IP (prefer outbound)
	...
	SystemInfo   *SystemInfo            `protobuf:"bytes,7,opt,name=system_info,json=systemInfo,proto3" json:"system_info,omitempty"`       // 系统信息 / System information
	HostId       uint64                 `protobuf:"varint,8,opt,name=host_id,json=hostId,proto3" json:"host_id,omitempty"`                  // 关联的主机 ID (可选，用于显式绑定) / Associated host ID (optional, for explicit binding)
	// 本机全部非回环网卡 IP，用于校验用户填写的主机 IP 是否属于该机器
	// All non-loopback local IPs; used to verify whether the user-entered host IP belongs to this machine
...
func (x *RegisterRequest) GetHostId() uint64 {
	if x != nil {
		return x.HostId
	}
	return 0
...
const file_agent_agent_proto_rawDesc = "" +
	...
	"\acursors\x18\x01 \x03(\v2%.seatunnel.agent.v1.DiagnosticsCursorR\acursors\"\xb6\x02\n" +
	...
	"systemInfo\x12\x17\n" +
	"\ahost_id\x18\b \x01(\x04R\x06hostId\x12!\n" +
	"\fip_addresses\x18\t \x03(\tR\vipAddresses\"\x92\x01\n" +
	"\n" +
	"SystemInfo\x12\x1b\n" +
